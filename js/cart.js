...
// New function to go to pay.php with total
...
function goToPayment() {
    ...
    // Redirect to pay.php with total and product_ids
    window.location.href = `pay.php?total=${cartTotal.toFixed(2)}&products=${encodeURIComponent(productIds)}`;
}
