                        ...
                        <div class="carousel-caption-1">
                            <div class="carousel-caption-1-content" style="max-width: 900px;">
                                ...
                                <h1 class="display-2 text-capitalize text-white mb-4 fadeInLeft animated"
                                    data-animation="fadeInLeft" data-delay="1.3s" style="animation-delay: 1.3s;">Pure
                                    Water, Better Tomorrow!</h1>
                                <p class="mb-5 fs-5 text-white fadeInLeft animated" data-animation="fadeInLeft"
                                    data-delay="1.5s" style="animation-delay: 1.5s;">Providing top-quality water
                                    solutions for homes and businesses with advanced filtration and purification,</p>
                        ...
                        <div class="carousel-caption-2">
                            <div class="carousel-caption-2-content" style="max-width: 900px;">
                                ...
                                <p class="mb-5 fs-5 text-white fadeInRight animated" data-animation="fadeInRight"
                                    data-delay="1.5s" style="animation-delay: 1.5s;">Reliable, efficient, and
                                    eco-friendly water treatment tailored for residential and commercial use,
                                </p>
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="product-item">
                        <img src="img/tractor-water-tanker-2.webp" class="w-100 rounded-top" height="375px" alt="Image">
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="product-item">
                        <img src="img/camper1.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="product-content bg-light text-center rounded-bottom p-4">
                            <p>20L Campers</p>
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="product-item">
                        <img src="img/bottle3.jpeg" class="img-fluid w-100 rounded-top" alt="Image">
                        <div class="product-content bg-light text-center rounded-bottom p-4">
                            <p>6L 3 Bottles</p>
            ...
            <div class="row g-5">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="about-item">
                        ...
                        <p class="mb-4">Whether you require water bottles for convenience, water campers for events, or
            ...
            <div class="row gx-0 gy-4 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="d-flex">
                                    <div class="service-content text-end">
                                        ...
                                        <p class="mb-0">We provide clean, safe water solutions for homes with
                                            filtration, softening, and purification services.</p>
                                    </div>
                                    <div class="ps-4">
                            ...
                            <div class="col-12">
                                <div class="d-flex">
                                    <div class="service-content text-end">
                                        ...
                                        <p class="mb-0">We offer reliable water solutions for businesses, ensuring pure
                                            and efficient water supply for all commercial needs.</p>
                                    </div>
                                    <div class="ps-4">
                    ...
                    <div class="service-item rounded p-4 mb-0">
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex">
                                    <div class="service-content text-end">
                                        <a href="#" class="h4 d-inline-block mb-3">Consistent Water Supply</a>
                                        <p class="mb-0">Our solutions ensure an uninterrupted water supply, reducing
                                            downtime and improving operational efficiency.</p>
                                    </div>
                                    <div class="ps-4">
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="bg-transparent">
                        <img src="img/bottles-water.png" class="img-fluid w-100" alt="">
                    </div>
                </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex">
                                    ...
                                    <div class="service-content">
                                        <a href="#" class="h4 d-inline-block mb-3">Custom Solutions</a>
                                        <p class="mb-0">Whether it's hotels, offices, hospitals, or manufacturing
                                            plants, we design water treatment systems tailored to specific business
                                            needs.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex">
                                    ...
                                    <div class="service-content">
                                        ...
                                        <p class="mb-0">Strict government regulations on water quality and wastewater
                                            management are pushing businesses to adopt efficient water treatment
                                            solutions.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex">
                                    ...
                                    <div class="service-content">
                                        <a href="#" class="h4 d-inline-block mb-3">Cost-Effective & Sustainable</a>
                                        <p class="mb-0">We offer energy-efficient and eco-friendly water solutions that
                                            reduce waste and operational costs.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container pb-5">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="img/watersupplytanker.jpg" class="img-fluid rounded-top w-100"
                                style="height: 250px;" alt="">
                            <div class="blog-date px-4 py-2"><i class="fa fa-calendar-alt me-1"></i> Jan 30 2025</div>
                        </div>
                        <div class="blog-content rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-3">The Future of Water Tanker Services</a>
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="img/Camper-Supplier-jeep.jpg" class="img-fluid rounded-top w-100" alt="">
                            <div class="blog-date px-4 py-2"><i class="fa fa-calendar-alt me-1"></i> Feb 22 2025</div>
                        </div>
                        <div class="blog-content rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-3">Water Campers: A Portable Water Solution</a>
                            <p>Water campers provide a convenient and mobile solution for transporting and storing water
                ...
                <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="blog-item">
                        <div class="blog-img">
                            <img src="img/bottle-blog.jpg" class="img-fluid rounded-top w-100" style="height:255px;"
                                alt="">
                            <div class="blog-date px-4 py-2"><i class="fa fa-calendar-alt me-1"></i> Mar 19 2025</div>
                        </div>
                        <div class="blog-content rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-3">Water Bottles: A Convenient Hydration
                                Solution</a>
                            <p>Water bottles are essential for maintaining hydration throughout the day, whether at
        ...
        <div class="container pb-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div class="testimonial-item text-center p-4">
                    <p>⭐ "Reliable and clean water supply!" – Our business depends on consistent water delivery, and
                        this service has never let us down. Highly recommended! – Aman Nagar.
                    </p>
                    <div class="d-flex justify-content-center mb-4">
                        <img src="img/aman.jpg" class="img-fluid border border-4 border-primary"
                            style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                    </div>
                    <div class="d-block">
                        <h4 class="text-dark">Aman Nagar</h4>
                        <p class="m-0 pb-3">shopkeeper</p>
                ...
                <div class="testimonial-item text-center p-4">
                    <p>⭐ "Best solution for outdoor needs!" – The water camper is a game changer for our adventure
                        trips. Safe and easy to use!.
                    </p>
                    <div class="d-flex justify-content-center mb-4">
                        <img src="img/abhishek.jpg" class="img-fluid border border-4 border-primary"
                            style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                    </div>
                    <div class="d-block">
                        <h4 class="text-dark">Abhishek Jawriya</h4>
                        <p class="m-0 pb-3">Business-Men</p>
                        <div class="d-flex justify-content-center text-secondary">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="testimonial-item text-center p-4">
                    <p>⭐ "Perfect for home use!" – The water filtration system has improved our family's health. Great
                        quality and service!.
                    </p>
                    <div class="d-flex justify-content-center mb-4">
                        <img src="img/ayaj.jpg" class="img-fluid border border-4 border-primary"
                            style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                    </div>
                    <div class="d-block">
                        <h4 class="text-dark">Ayaj Sheik</h4>
                        <p class="m-0 pb-3">shopkeeper</p>
                        <div class="d-flex justify-content-center text-secondary">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                ...
                <div class="testimonial-item text-center p-4">
                    <p>⭐ "Efficient and affordable!" – The tanker service is prompt, and the pricing is fair. We rely on
                        them for our construction projects. – Deepraj Upadhyay.
                    </p>
                    <div class="d-flex justify-content-center mb-4">
                        <img src="img/deepraj.jpg" class="img-fluid border border-4 border-primary"
                            style="width: 100px; height: 100px; border-radius: 50px;" alt="">
                    </div>
                    <div class="d-block">
                        <h4 class="text-dark">Deepraj Upadhyay</h4>
                        <p class="m-0 pb-3">Business-Men</p>
                        <div class="d-flex justify-content-center text-secondary">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                    ...
                    <div class="footer-item d-flex flex-column">
                        ...
                        <div class="position-relative">
                            <input class="form-control rounded-pill w-100 py-3 ps-4 pe-5" type="text"
                                ...
                                <a href="sing.html"><button type="button"
                                class="btn btn-secondary rounded-pill position-absolute top-0 end-0 py-2 px-4 mt-2 me-2">Sign In</button></a>
