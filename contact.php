            ...
            <div class="row g-5">
                <div class="col-lg-6 h-100 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="text-center mx-auto pb-5" style="max-width: 800px;">
                        ...
                        <p class="mb-0">Let's connect with us and it's greate to share your Experiance with us.</p>
                    </div>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="d-inline-flex rounded bg-white w-100 p-4">
                                ...
                                <div>
                                    <h4>Address</h4>
                                    <p class="mb-0">Medicaps University, Indore, MP</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xl-6">
                            <div class="d-inline-flex rounded bg-white w-100 p-4">
                                ...
                                <div>
                                    <h4>Mail Us</h4>
                                    <p class="mb-0">dhakadram668@gmail.com</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xl-6">
